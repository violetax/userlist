...
describe('The User API', () => {
  // Specific test
  it('Returns a list of all users', async () => { // async: says NOT to continue until ANY await request n the function is fulfilled, sequentially
    // AWAIT 1:
    ...
    // Now, res is full of our entire server response
